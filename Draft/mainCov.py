...
from Draft.trainingCov import Trainer
...
parser.add_argument('--data', type=str, choices=['deterministic_lv','functional','functional1','functionalCov'], default='deterministic_lv')
...
def run(device,seed):
    ...
    if args.data == 'deterministic_lv':
        ...
        dataset = FunctionalData1(sdense=sdense, num_samples=args.num_samples, sd_u=args.sd_u, sd_v=args.sd_v,
                                  rho_b=args.rho_b,rho_w=args.rho_w, scenario=args.scenario,num_obs_x1=args.num_obs_x1,
                                  num_obs_x2=args.num_obs_x2,lambdaX1=args.lambdaX1,lambdaX2=args.lambdaX2,ts_equal=args.ts_equal,seed=seed)
    elif args.data == 'functionalCov':
        sdense = np.linspace(0, args.rangeMax, 100)
        dataset = FunctionalDataCov(sdense=sdense, num_samples=args.num_samples, sd_u=args.sd_u, sd_v=args.sd_v,
                                  rho_b=args.rho_b, rho_w=args.rho_w, scenario=args.scenario,
                                  num_obs_x1=args.num_obs_x1,
                                  num_obs_x2=args.num_obs_x2, lambdaX1=args.lambdaX1, lambdaX2=args.lambdaX2,
                                  ts_equal=args.ts_equal, seed=seed)
