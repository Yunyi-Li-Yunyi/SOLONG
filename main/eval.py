...
folder='/N/u/liyuny/Carbonate/cnode_ffr_main/results/deterministic_lv/vnode/sim_b2_0.3s_5_3'
...
predX_all=torch.stack(predX.tolist())
...
# plt.show()
plt.savefig(folder + "/summaryPlot1")
