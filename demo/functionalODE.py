...
# y(t) = x1(s) + e
def generate_yx1x2(nsubject=200, # number of subjects
                      ny=60, # number of grids on which response curves are observed
		      nx1=50, # number of grids on which X1(s) predictor curves are observed
		      nx2=70, # number of grids on whcih X2(r) predictor curves are observed
                      nsample=100,
                      tstart=0.1,
                      tstop=6, 
		      sstart=0.1,
